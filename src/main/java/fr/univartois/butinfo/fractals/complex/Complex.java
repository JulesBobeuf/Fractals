...
public class Complex implements IComplex {
     ...
     *
     * @see
     * fr.univartois.butinfo.fractals.complex.IComplex#add(fr.univartois.butinfo.fractals.
     * complex.IComplex)
     */
    @Override
     ...
     *
     * @see
     * fr.univartois.butinfo.fractals.complex.IComplex#subtract(fr.univartois.butinfo.
     * fractals.complex.IComplex)
     */
    @Override
     ...
     *
     * @see
     * fr.univartois.butinfo.fractals.complex.IComplex#multiply(fr.univartois.butinfo.
     * fractals.complex.IComplex)
     */
    @Override
    public IComplex multiply(IComplex other) {
        return new Complex((re * other.getRealPart()) - (im * other.getImaginaryPart()),
                (im * other.getRealPart()) + (re * other.getImaginaryPart()));
    }

    /*
     * (non-Javadoc)
     *
     * @see fr.univartois.butinfo.fractals.complex.IComplex#divide(fr.univartois.butinfo.
     * fractals.complex.IComplex)
     */
    @Override
    public IComplex divide(IComplex other) {
        ...
        if (den.getRealPart() == 0) {
            return new Complex(num.getRealPart() / den.getImaginaryPart(),
                    (num.getImaginaryPart() / den.getImaginaryPart()) * -1);
        }
        if (den.getImaginaryPart() == 0) {
            return new Complex(num.getRealPart() / den.getRealPart(),
                    num.getImaginaryPart() / den.getRealPart());
        }
        return new Complex(num.getRealPart() / den.getRealPart(),
                num.getImaginaryPart() / den.getImaginaryPart());
    }
